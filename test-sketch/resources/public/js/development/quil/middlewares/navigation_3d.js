...
var vec__1801 = axis;
var a_x = cljs.core.nth.call(null,vec__1801,(0),null);
var a_y = cljs.core.nth.call(null,vec__1801,(1),null);
var a_z = cljs.core.nth.call(null,vec__1801,(2),null);
var vec__1804 = v;
var x = cljs.core.nth.call(null,vec__1804,(0),null);
var y = cljs.core.nth.call(null,vec__1804,(1),null);
var z = cljs.core.nth.call(null,vec__1804,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__1807,p__1808){
var vec__1809 = p__1807;
var u1 = cljs.core.nth.call(null,vec__1809,(0),null);
var u2 = cljs.core.nth.call(null,vec__1809,(1),null);
var u3 = cljs.core.nth.call(null,vec__1809,(2),null);
var vec__1812 = p__1808;
var v1 = cljs.core.nth.call(null,vec__1812,(0),null);
var v2 = cljs.core.nth.call(null,vec__1812,(1),null);
var v3 = cljs.core.nth.call(null,vec__1812,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__1815_SHARP_){
return (p1__1815_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__1816_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__1817_SHARP_,angle_lr),angle_ud);
...
var map__1819 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__1819__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__1819__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__1821 = cljs.core._EQ_;
var expr__1822 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__1821.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__1822))){
return straight;
} else {
if(cljs.core.truth_(pred__1821.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__1822))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__1821.call(null,quil.middlewares.navigation_3d.space,expr__1822))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__1821.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__1822))){
return up;
} else {
if(cljs.core.truth_(pred__1821.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__1822))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__1821.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__1822))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__1819,map__1819__$1,up,straight){
return (function (p1__1818_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__1818_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__1819,map__1819__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__1824_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__1824_SHARP_);
});})(initial_state))
);
});
/**
...
var map__1825_1836 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1825_1837__$1 = (((((!((map__1825_1836 == null))))?(((((map__1825_1836.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1825_1836.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1825_1836):map__1825_1836);
var vec__1826_1838 = cljs.core.get.call(null,map__1825_1837__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_1839 = cljs.core.nth.call(null,vec__1826_1838,(0),null);
var c_y_1840 = cljs.core.nth.call(null,vec__1826_1838,(1),null);
var c_z_1841 = cljs.core.nth.call(null,vec__1826_1838,(2),null);
var vec__1829_1842 = cljs.core.get.call(null,map__1825_1837__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_1843 = cljs.core.nth.call(null,vec__1829_1842,(0),null);
var u_y_1844 = cljs.core.nth.call(null,vec__1829_1842,(1),null);
var u_z_1845 = cljs.core.nth.call(null,vec__1829_1842,(2),null);
var vec__1832_1846 = cljs.core.get.call(null,map__1825_1837__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_1847 = cljs.core.nth.call(null,vec__1832_1846,(0),null);
var p_y_1848 = cljs.core.nth.call(null,vec__1832_1846,(1),null);
var p_z_1849 = cljs.core.nth.call(null,vec__1832_1846,(2),null);
quil.core.camera.call(null,p_x_1847,p_y_1848,p_z_1849,(p_x_1847 + c_x_1839),(p_y_1848 + c_y_1840),(p_z_1849 + c_z_1841),u_x_1843,u_y_1844,u_z_1845);
